...
namespace ECSTween
{
    ...
    public class TweenUpdateTransformSystem : JobComponentSystem
    {
        ...
        {
            m_TransformGroup = GetComponentGroup(ComponentType.ReadOnly(typeof(TweenTime)), typeof(UnityEngine.Transform));
        }
